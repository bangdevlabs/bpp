...
TEST_FILE = "raylib_demo2.bpp"
OUTPUT_IR = "raylib_demo2.json"
SHIM_C = "bpp_shim2.c"
...
def generate_c_shim(ir):
    with open(SHIM_C, "w") as f:
        ...
        # Rename this function to bpp_alloc
        ...
        for name, data in ir["functions"].items():
            ...
            for stmt in data["body"]:
                if stmt.get("type") == "decl":
                    ...
                    # Agora o translate_node cuida de IFs e WHILEs sozinho
